...
namespace ImGui
{
	void loadStyle()
	{
		...
		colors[ImGuiCol_TitleBgActive] = ImVec4(0.00f, 0.47f, 0.80f, 1.00f);
		...
		colors[ImGuiCol_ScrollbarGrab] = ImVec4(0.00f, 0.39f, 0.47f, 1.00f);
		colors[ImGuiCol_ScrollbarGrabHovered] = ImVec4(0.00f, 0.48f, 0.80f, 1.00f);
		colors[ImGuiCol_ScrollbarGrabActive] = ImVec4(0.00f, 0.48f, 0.80f, 1.00f);
		colors[ImGuiCol_CheckMark] = ImVec4(0.90f, 0.90f, 0.90f, 0.50f);
		colors[ImGuiCol_SliderGrab] = ImVec4(0.00f, 0.47f, 0.80f, 1.00f);
		...
		colors[ImGuiCol_Header] = ImVec4(0.02f, 0.29f, 0.53f, 1.00f);
		colors[ImGuiCol_HeaderHovered] = ImVec4(0.00f, 0.47f, 0.80f, 1.00f);
