...
struct ImVec2
{
    ...
    ImVec2 operator*(float v) { return ImVec2(x * v, y * v); }
...
struct ImVec4
{
    ...
    ImVec4 operator*(float v) { return ImVec4(x * v, y * v, z * v, w * v); }
    ImVec4 operator+(ImVec4 v) { return ImVec4(x + v.x, y + v.y, z + v.z, w + v.w); }
